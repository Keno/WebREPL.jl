...
var MSG_INPUT_EVAL              = 1;
var MSG_INPUT_REPLAY_HISTORY    = 2;
var MSG_INPUT_GET_USER          = 3;
var MSG_INPUT_AUTHENTICATE      = 4;
...
var ws = new WebSocket("ws://localhost:8000/repl/socket", "julia-repl");
...
// Initial Request
ws.onopen = function() {
    send_msg([MSG_INPUT_AUTHENTICATE,readCookie("SessionId")])
    send_msg([MSG_INPUT_GET_USER])
}
